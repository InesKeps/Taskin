...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-gray-950 flex items-center justify-center p-4 relative overflow-hidden">
      {/* Ambient glows */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-96 h-96 bg-fuchsia-500/8 dark:bg-fuchsia-500/6 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute top-1/3 left-1/2 translate-x-8 w-64 h-64 bg-violet-500/8 dark:bg-violet-500/6 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="relative w-full max-w-sm">
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-8 shadow-xl shadow-black/5 dark:shadow-black/40">
          ...
          <form onSubmit={(e) => { e.preventDefault(); void formik.handleSubmit(); }} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3 py-2.5 bg-gray-50 dark:bg-gray-800/60 border border-gray-200 dark:border-gray-700/50 rounded-xl text-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-fuchsia-500/30 focus:border-fuchsia-500/50 transition-all"
                />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-fuchsia-500 dark:text-gray-500 dark:hover:text-fuchsia-400 transition-colors"
                >
